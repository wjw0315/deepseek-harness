...
export { DESKTOP_INSTALL_RECOVERY_STATE_ENV, desktopInstallRecoveryStatePath, DesktopInstallRecoveryStore } from './install-recovery.ts'
export type { DesktopInstallRecoveryClaim, DesktopInstallRecoveryTransaction } from './install-recovery.ts'
