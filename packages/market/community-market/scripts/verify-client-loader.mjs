...
if (registration?.id !== '@deepseek-ai/dsh-community-market' || typeof registration.factory !== 'function') {
  throw new Error('market client did not register the expected Loader module')
}

process.stdout.write('verify-market-client-loader: @deepseek-ai/dsh-community-market registered one client module\n')
