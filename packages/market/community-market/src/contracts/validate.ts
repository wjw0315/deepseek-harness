...
/**
 * Validate and normalize an untrusted catalog source manifest.
 * @param value - The raw manifest value to parse.
 * @returns the validated source manifest.
 */
...
/**
 * Validate an untrusted catalog query against its schema.
 * @param value - The raw query value to parse.
...
/**
 * Validate an untrusted provider page and enforce its item limit and uniqueness invariants.
 * @param value - The raw provider page value to parse.
 * @param effectiveLimit - The effective query page limit; when set, the page must not exceed it.
 * @returns the validated provider page.
 */
...
/**
 * Validate a normalized catalog snapshot and enforce provenance-uniqueness invariants.
 * @param value - The raw snapshot value to parse.
...
/**
 * Validate the local catalog source registrations before they are persisted.
 * @param records - The source records to validate; throws on the first violation.
 */
