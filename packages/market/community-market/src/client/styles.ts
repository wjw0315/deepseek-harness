...
/** Injects the community-market stylesheet into the document head, then returns a disposer that removes it.
 * @returns A function that removes the injected stylesheet; a no-op when the styles were already installed. */
