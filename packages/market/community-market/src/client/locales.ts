/** Simplified-Chinese dictionary for the community-market locale namespace, read-only. */
export const zh = {
  tab: '插件市场',
  title: '社区插件市场',
  subtitle: '从你选择的来源发现 DS-harness 插件',
  close: '关闭',
  closeMarket: '关闭插件市场',
  discover: '发现',
  installable: '可安装',
  ...
  manualInstallBody: '以下命令由 DS-harness 根据插件信息生成，可能与仓库中的说明不同。请先检查源码，再复制到 DSH 终端执行。',
  installCommand: '安装命令',
  ...
  restartError: '无法请求重启 DS-harness，请稍后手动重启。',
  installableBody: '这里显示从当前来源完整目录中初步筛选出的可安装插件。选择插件后，DS-harness 仍会再次验证版本、来源和兼容性。',
  ...
  desktopRequiredTitle: '需要 DS-harness',
  desktopUnavailable: '安装、卸载、禁用和启用只在 DS-harness 中可用；你仍然可以浏览插件目录。',
  ...
  confirmInstallBody: '请确认 DS-harness 验证的 npm 包、版本和目标配置。',
  confirmUninstallTitle: '确认卸载插件',
  confirmUninstallBody: '只会卸载当前配置中由插件市场安装并验证过的这个插件。',
  confirmDisableTitle: '确认禁用外部插件',
  confirmDisableBody: 'DS-harness 将停止在当前配置中加载这个插件，但不会卸载对应的 npm 包。',
  confirmEnableTitle: '确认启用插件',
  confirmEnableBody: 'DS-harness 将恢复在当前配置中加载这个插件。对应的代码会在重启后运行。',
  confirmInstall: '确认安装',
  ...
  operationRiskBeforeContact: '以错误方式安装插件，或者安装未经验证的插件，可能导致软件崩溃或异常。',
  restartAfterOperation: '操作完成后需要重启 DS-harness，改动才会生效。',
  disableWarning: '禁用不会卸载 npm 包，也不会隔离插件代码。',
  disableRecoveryWarning: '如果插件导致 DS-harness 无法进入此页面，需要按照恢复文档手动处理。',
  ...
  restartRequiredTitle: '需要重启 DS-harness',
  restartRequiredBody: '请重启 DS-harness，让当前配置加载最新的插件状态。',
  restartLater: '稍后重启',
  restartNow: '立即重启',
  restarting: '正在重启...',
  done: '完成',
...
/** The union of message keys defined by the zh dictionary. */
export type MarketLocaleKey = keyof typeof zh

/** English dictionary for the community-market locale namespace, covering every MarketLocaleKey. */
export const en: Record<MarketLocaleKey, string> = {
  tab: 'Plugin Market',
  title: 'Community Plugin Market',
  subtitle: 'Discover DS-harness plugins from sources you choose',
  close: 'Close',
  ...
  manualInstallBody: 'DS-harness generated this command from the plugin information, so it may differ from the repository instructions. Review the source first, then copy it into DSH Terminal.',
  ...
  restartError: 'DS-harness could not be restarted. Restart it manually when convenient.',
  installableBody: 'This view shows plugins pre-screened from the current source’s complete catalog. DS-harness verifies the version, source, and compatibility again after selection.',
  ...
  desktopRequiredTitle: 'DS-harness is required',
  desktopUnavailable: 'Install, uninstall, disable, and enable are available only in DS-harness. You can still browse the catalog.',
  ...
  confirmInstallBody: 'Review the npm package, version, and target profile verified by DS-harness.',
  ...
  confirmDisableBody: 'DS-harness will stop loading this plugin in the active profile without uninstalling its npm package.',
  confirmEnableTitle: 'Confirm plugin enable',
  confirmEnableBody: 'DS-harness will load this plugin in the active profile again. Its code will run after restart.',
  ...
  operationRiskBeforeContact: 'Installing a plugin incorrectly, or installing an unverified plugin, may cause crashes or unexpected behavior.',
  restartAfterOperation: 'Restart DS-harness after this operation for the change to take effect.',
  disableWarning: 'Disabling does not uninstall the npm package or isolate the plugin’s code.',
  disableRecoveryWarning: 'If the plugin prevents DS-harness from reaching this page, use the manual recovery steps.',
  ...
  restartRequiredTitle: 'Restart DS-harness',
  restartRequiredBody: 'Restart DS-harness so the current profile loads its updated plugin state.',
