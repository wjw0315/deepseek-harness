// Shared vi.mock installs for the community-market client tests. This repo's
// root vitest config loads only ./scripts/test-invariants.ts as setup, so the
// client specs must install these mocks themselves. Import this module first,
// before any component import, so the hoisted factories own
// @deepseek-ai/dsh-client-runtime/client (defineStore) and
// @deepseek-ai/dsh-client-ui-primitives exactly as the market client src uses
// them. The src is the authority on which named exports the factory must
// provide; the factory shapes mirror the upstream package's tests/setup.tsx.
