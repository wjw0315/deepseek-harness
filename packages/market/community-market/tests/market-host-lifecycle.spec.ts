...
import { marketRoutes } from '../src/host/routes.ts'

type Handler = (req: unknown, res: unknown) => void | Promise<void>

interface Injection {
  readonly names: readonly string[]
  readonly factory: (ctx: { get(name: string): unknown; effect(factory: () => (() => void) | undefined): void }) => void
  cleanups: (() => void)[]
  active: boolean
}
...
function createHarness() {
  ...
  const registerEffect = (factory: () => (() => void) | undefined, owner = activeInjection): void => {
  ...
  const context = {
    ...
    effect: (factory: () => (() => void) | undefined) => { registerEffect(factory) },
    inject: (
      names: readonly string[],
      factory: (ctx: { get(name: string): unknown; effect(factory: () => (() => void) | undefined): void }) => void,
    ) => {
